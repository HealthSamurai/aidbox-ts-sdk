...
const iconBaseClasses =
  "absolute top-1/2 -translate-y-1/2 cursor-default z-10 flex items-center justify-center [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0";
...
const iconDisabledColor = "text-text-disabled  transition-colors duration-300";
