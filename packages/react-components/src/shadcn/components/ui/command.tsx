...
// Command Dialog
const commandDialogContentStyles = [
	// Layout
	"overflow-hidden",
	"p-0",
].join(" ");

const commandDialogCommandStyles = [
	// Group headings
...
const commandInputWrapperStyles = [
	// Layout
	"flex",
	"h-9",
	"items-center",
