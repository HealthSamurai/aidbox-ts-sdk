...
3. Reference the exact import path from `@aidbox/react-components`
4. Apply the correct design tokens (colors, spacing, typography) from the system

All components are exported from `@aidbox/react-components` (source: `packages/react-components/src/index.tsx`).
CSS must be imported: `import "@aidbox/react-components/index.css"`.
...
### Button
- **Source**: `packages/react-components/src/shadcn/components/ui/button.tsx`
...
### IconButton
- **Source**: `packages/react-components/src/components/icon-button.tsx`
...
### SplitButton
- **Source**: `packages/react-components/src/components/split-button.tsx`
...
### ButtonDropdown
- **Source**: `packages/react-components/src/components/button-dropdown.tsx`
...
### Input
- **Source**: `packages/react-components/src/shadcn/components/ui/input.tsx`
...
### Textarea
- **Source**: `packages/react-components/src/shadcn/components/ui/textarea.tsx`
- **Description**: Multi-line text input, styled consistently with the design system.
- **Exports**: `Textarea`

### Select
- **Source**: `packages/react-components/src/shadcn/components/ui/select.tsx`
...
### Combobox
- **Source**: `packages/react-components/src/shadcn/components/ui/combobox.tsx`
- **Description**: Searchable select (autocomplete) combining a Popover with a Command input.
- **Exports**: `Combobox`

### Checkbox
- **Source**: `packages/react-components/src/shadcn/components/ui/checkbox.tsx`
...
### Switch
- **Source**: `packages/react-components/src/shadcn/components/ui/switch.tsx`
- **Description**: Toggle switch for boolean on/off values.
- **Props**: `size` (`"regular"` | `"small"`), plus Radix Switch props.
- **Exports**: `Switch`

### RadioGroup / RadioButtonGroup
- **Source (RadioGroup)**: `packages/react-components/src/shadcn/components/ui/radio-group.tsx`
- **Source (RadioButtonGroup)**: `packages/react-components/src/shadcn/components/ui/radio-button-group.tsx`
...
### Badge
- **Source**: `packages/react-components/src/shadcn/components/ui/badge.tsx`
...
### Tag
- **Source**: `packages/react-components/src/components/tag.tsx`
...
### Alert
- **Source**: `packages/react-components/src/shadcn/components/ui/alert.tsx`
...
### AlertDialog
- **Source**: `packages/react-components/src/shadcn/components/ui/alert-dialog.tsx`
...
### Dialog
- **Source**: `packages/react-components/src/shadcn/components/ui/dialog.tsx`
...
### Sheet
- **Source**: `packages/react-components/src/shadcn/components/ui/sheet.tsx`
...
### Drawer
- **Source**: `packages/react-components/src/shadcn/components/ui/drawer.tsx`
...
### Popover
- **Source**: `packages/react-components/src/shadcn/components/ui/popover.tsx`
...
### HoverCard
- **Source**: `packages/react-components/src/shadcn/components/ui/hover-card.tsx`
- **Description**: Content card that appears on hover over a trigger.
- **Exports**: `HoverCard`, `HoverCardTrigger`, `HoverCardContent`

### Tooltip
- **Source**: `packages/react-components/src/shadcn/components/ui/tooltip.tsx`
- **Description**: Small floating label on hover/focus for additional info.
- **Exports**: `Tooltip`, `TooltipTrigger`, `TooltipContent`, `TooltipProvider`

### DropdownMenu
- **Source**: `packages/react-components/src/shadcn/components/ui/dropdown-menu.tsx`
...
### ContextMenu
- **Source**: `packages/react-components/src/shadcn/components/ui/context-menu.tsx`
...
### Menubar
- **Source**: `packages/react-components/src/shadcn/components/ui/menubar.tsx`
...
### NavigationMenu
- **Source**: `packages/react-components/src/shadcn/components/ui/navigation-menu.tsx`
...
### Tabs
- **Source**: `packages/react-components/src/shadcn/components/ui/tabs.tsx`
...
### Accordion
- **Source**: `packages/react-components/src/shadcn/components/ui/accordion.tsx`
- **Description**: Expandable/collapsible content sections.
- **Exports**: `Accordion`, `AccordionItem`, `AccordionTrigger`, `AccordionContent`

### Collapsible
- **Source**: `packages/react-components/src/shadcn/components/ui/collapsible.tsx`
- **Description**: Simple open/close toggle for a single content section.
- **Exports**: `Collapsible`, `CollapsibleTrigger`, `CollapsibleContent`

### Table
- **Source**: `packages/react-components/src/shadcn/components/ui/table.tsx`
- **Description**: Styled HTML table primitives.
- **Exports**: `Table`, `TableHeader`, `TableBody`, `TableFooter`, `TableHead`, `TableRow`, `TableCell`, `TableCaption`

### DataTable
- **Source**: `packages/react-components/src/components/data-table.tsx`
...
### Card
- **Source**: `packages/react-components/src/shadcn/components/ui/card.tsx`
...
### Tile
- **Source**: `packages/react-components/src/components/tile.tsx`
...
### SegmentControl
- **Source**: `packages/react-components/src/components/segment-control.tsx`
...
### Toolbar
- **Source**: `packages/react-components/src/components/toolbar.tsx`
...
### TreeView
- **Source**: `packages/react-components/src/components/tree-view.tsx`
...
### CopyIcon
- **Source**: `packages/react-components/src/components/copy-icon.tsx`
...
### Breadcrumb
- **Source**: `packages/react-components/src/shadcn/components/ui/breadcrumb.tsx`
- **Description**: Navigation breadcrumb trail.
- **Exports**: `Breadcrumb`, `BreadcrumbList`, `BreadcrumbItem`, `BreadcrumbLink`, `BreadcrumbPage`, `BreadcrumbSeparator`, `BreadcrumbEllipsis`

### Pagination
- **Source**: `packages/react-components/src/shadcn/components/ui/pagination.tsx`
...
### Avatar
- **Source**: `packages/react-components/src/shadcn/components/ui/avatar.tsx`
- **Description**: Circular avatar image with fallback initials.
- **Exports**: `Avatar`, `AvatarImage`, `AvatarFallback`

### Calendar
- **Source**: `packages/react-components/src/shadcn/components/ui/calendar.tsx`
- **Description**: Date picker calendar (react-day-picker based).
- **Exports**: `Calendar`

### Carousel
- **Source**: `packages/react-components/src/shadcn/components/ui/carousel.tsx`
...
### Chart
- **Source**: `packages/react-components/src/shadcn/components/ui/chart.tsx`
...
### Progress
- **Source**: `packages/react-components/src/shadcn/components/ui/progress.tsx`
- **Description**: Horizontal progress bar.
- **Exports**: `Progress`

### Slider
- **Source**: `packages/react-components/src/shadcn/components/ui/slider.tsx`
- **Description**: Range slider input.
- **Exports**: `Slider`

### Skeleton
- **Source**: `packages/react-components/src/shadcn/components/ui/skeleton.tsx`
- **Description**: Placeholder loading skeleton with pulse animation.
- **Exports**: `Skeleton`

### Separator
- **Source**: `packages/react-components/src/shadcn/components/ui/separator.tsx`
- **Description**: Visual divider line (horizontal or vertical).
- **Exports**: `Separator`

### ScrollArea
- **Source**: `packages/react-components/src/shadcn/components/ui/scroll-area.tsx`
- **Description**: Custom scrollable container with styled scrollbars.
- **Exports**: `ScrollArea`, `ScrollBar`

### AspectRatio
- **Source**: `packages/react-components/src/shadcn/components/ui/aspect-ratio.tsx`
- **Description**: Maintains a fixed aspect ratio for child content.
- **Exports**: `AspectRatio`

### Resizable
- **Source**: `packages/react-components/src/shadcn/components/ui/resizable.tsx`
- **Description**: Resizable panel layout (split panes).
- **Exports**: `ResizablePanelGroup`, `ResizablePanel`, `ResizableHandle`

### Sidebar
- **Source**: `packages/react-components/src/shadcn/components/ui/sidebar.tsx`
...
### Label
- **Source**: `packages/react-components/src/shadcn/components/ui/label.tsx`
- **Description**: Form label element.
- **Exports**: `Label`

### Form
- **Source**: `packages/react-components/src/shadcn/components/ui/form.tsx`
...
### InputOTP
- **Source**: `packages/react-components/src/shadcn/components/ui/input-otp.tsx`
...
### Toggle / ToggleGroup
- **Source (Toggle)**: `packages/react-components/src/shadcn/components/ui/toggle.tsx`
- **Source (ToggleGroup)**: `packages/react-components/src/shadcn/components/ui/toggle-group.tsx`
...
### Sonner (Toast)
- **Source**: `packages/react-components/src/shadcn/components/ui/sonner.tsx`
...
### Command
- **Source**: `packages/react-components/src/shadcn/components/ui/command.tsx`
...
- **Source**: `packages/react-components/src/icons.tsx`
...
All tokens are CSS custom properties defined in `packages/react-components/src/tokens.css` and `packages/react-components/src/index.css`.
...
- `useMobile` — from `@aidbox/react-components` — detects mobile viewport.

## Utilities

- `cn(...classes)` — Tailwind class merger (clsx + twMerge). Import from `@aidbox/react-components`.
...
3. **Icons**: Use `lucide-react` for standard icons. Use the custom icons from `@aidbox/react-components` for domain-specific FHIR icons only.
4. **Import everything from `@aidbox/react-components`** — the library re-exports all components from a single entry point.
